...
def recruitment_management(parent):
    ...
    info2_label = Label(dashboard_window, text="Monitor your organization's hiring process here", fg='#3468C0', bg='#FFDD95',
                        font=font_info2)
    ...
    columns = ("Role","Hiring Status","Due Date")
    ...
    fake_data = [
        ("Software Engineer","Interview Scheduled","12th February 2025"),
        ("Data scientist", "Vacant", "5th March 2025"),
        ("Data engineery", "Hired", "5th March 2025"),
