...
def performance_management(parent):
    ...
    columns = ("Name","Ratings","Remarks","Pipeline","Skilling Up")
    ...
    fake_data = [
        ("Krishna Kaul", "4.5", "Better team work needed", "YES", "YES"),
        ("Dilin Nair", "4.5", "Needs experience with conversation skills", "YES", "NO"),
        ("Vivian Divine", "4.5", "Excellent", "NO", "NO"),
        ("Marshal Mathers", "5", "Excellent", "NO", "NO"),
        ("Kendrick Lamar", "5", "Excellent", "NO", "NO"),
        ("Frank Miller", "5", "Excellent", "NO"),
    ]
